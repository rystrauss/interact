...
class SegmentTree:
    ...
    This implementation is copied from RLLib:
    https://github.com/ray-project/ray/blob/d7c95a4a9065cbad73901b4c1de087837e260316/rllib/execution/segment_tree.py#L155
