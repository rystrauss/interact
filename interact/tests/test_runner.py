...
def test_run(cartpole_runner):
    ...
    EXPECTED_OBS = np.array([[-0.03233464, 0.01765816, -0.02843043, 0.0147195],
    ...
    EXPECTED_NEXT_OBS = np.array([[-0.03198147, -0.17704477, -0.02813604, 0.29829845],
                                  [-0.03552237, -0.37175459, -0.02217007, 0.58197668],
                                  [-0.04295746, -0.56655901, -0.01053054, 0.86759404],
                                  [-0.05428864, -0.7615361, 0.00682134, 1.15694754],
                                  [-0.06951936, -0.56650373, 0.02996029, 0.86641125],
    ...
    np.testing.assert_allclose(episodes[0][SampleBatch.NEXT_OBS], EXPECTED_NEXT_OBS, 1e-06)
